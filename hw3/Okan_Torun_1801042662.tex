...
\end{flushleft}
(a) It is not possible to draw a graph from the starting point without repeating the vertex, passing through each vertex and coming back to the starting point..Ex(g-h-c-b-a-d-o-i-j-k-q-l-m-f-g)(p,n,e are not visited)
\newline
\newline
(b) It is not possible to draw a graph from the starting point without repeating the vertex, passing through each vertex and coming back to the starting point..Ex(g,b,a,d,c,e)(f is not visited)
\newline
\newline
\begin{flushleft}
(c) This graph has Hamilton circuit.Ex(a-d-g-h-i-f-c-b-e-a)
\end{flushleft}
\newpage
...
\begin{figure*}[htp]
    \centering
    \includegraphics[scale=0.83]{Problem3.JPG} 
